...
sudo git clone --recurse-submodules https://github.com/chopicalqui/CovenantInternal.git /opt/CovenantInternal
cd /opt/CovenantInternal/
sudo git checkout webdelivery

cd /opt/CovenantInternal/Covenant/
